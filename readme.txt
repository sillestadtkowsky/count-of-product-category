...
Use the shortcode [so_cp_count] in your page or post content. You can also use the optional title and show_category_name attributes to customize the output. For example, [so_cp_count title="clothing" show_category_name="true"] will display the number of products in the "clothing" category along with the category name.

== Screenshots ==

Example output of the shortcode on a page.
== Changelog ==
